...
import EditRequestStatusHR from './EditRequestStatusHR';
...
export default function GetOneRequestHR() {
  const [request, setRequest] = useState<getRequest | null>(null);
  ...
  return (
    <div className="page-root">
      ...
      <EditRequestStatusHR id={request._id} />
    </div>
  );
}
